...
from src.misc import Color, FrameEffect
...
class Card(Base):
    ...
    # Note that Scryfall includes many promo cards, tokens, and other esoteric objects that do not
    ...
    # Always present except for the reversible_card layout where it will be absent; oracle_id will be
    # found on each face instead.
    ...
    produced_mana: Optional[Color] = None
    ...
    # See the Card Imagery article for more information.
    ...
    # usd, usd_foil, usd_etched, eur, eur_foil, eur_etched, and tix prices, as strings.
    ...
    purchase_uris: Optional[dict[str, Url]] = None
    # This card’s rarity.
